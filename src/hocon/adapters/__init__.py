...
``properties``, ``env``, ``jsonc``, ``json5`` and ``toml`` need nothing beyond
the standard library — TOML is read with :mod:`tomllib`, which Python 3.11
ships, and JSON5 with a hand-rolled scanner. ``yaml`` needs an extra:
